  ...
  function Store(methods, callback) {
    ...
    this.mixin = {
      componentDidMount: function() {
        // Ugly temporary fix to https://github.com/kenwheeler/mcfly/issues/45 : disable logging under IE9
        var warn = ('console' in window && 'bind' in console.log) ? (console.warn || console.log).bind(console) : function() {},
          changeFn;
